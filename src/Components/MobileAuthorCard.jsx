    ...
    return (
      <div style={{backgroundColor: '#f8be03', overflow: 'hidden', height: '100vh'}}>
        ...
        <div style={description}>
          <h1 style={{textAlign: 'left', fontSize: '2.4vh', lineHeight: '2.4vh'}}>ROSS NODELL was born and raised in Chicago. He relocated to New York City in the late 80s to marry a Chinese woman.  Little did he know her entire family was part of the deal. Ross worked on Wall Street before starting his own real estate investment firm. He now follows his passion as a writer.
